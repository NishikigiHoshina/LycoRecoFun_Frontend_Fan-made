...
<h1>站内管理</h1>
  ...
  <div>
    ...
    <div>
      ...
      <div v-if="imglinklist" class="clearfix">
        <div v-for="img in imglinklist" style="float: left; ">
          <img :src="img" style="height: 10vh;width: 15vh">
        </div>
        <el-button>更 改</el-button>
    ...
    <div>
      ...
      <section>
        <h4>联系站长功能启用</h4>
        <el-switch v-model="connect_function"></el-switch>
      </section>

      <section>
        <h4>上传作品功能启用</h4>
        <el-switch v-model="upload_function"></el-switch>
      </section>

      <section>
        <h4>资料库功能启用</h4>
        <el-switch v-model="database_function"></el-switch>
      </section>
